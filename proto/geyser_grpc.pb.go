...
func (UnimplementedGeyserServer) Subscribe(*SubscribeRequest, Geyser_SubscribeServer) error {
...
func _Geyser_Subscribe_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(GeyserServer).Subscribe(m, &geyserSubscribeServer{stream})
}
